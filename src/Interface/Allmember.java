...
public class Allmember extends javax.swing.JInternalFrame {
   ...
   Connection conn=null;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 440, 160, 50));
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
         ...
         try {
            String sql="SELECT `mid`, `name`, `lastname`, `birthday`, `gender`, `address`, `email`, `phone`, `type` FROM `addmember` WHERE name LIKE '%"+txtsearch.getText()+"%'";
