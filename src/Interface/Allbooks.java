...
public class Allbooks extends javax.swing.JInternalFrame {
   ...
   Connection conn=null;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 430, 160, 50));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 930, 330));
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
        try {
            String sql="SELECT `bid`, `name`, `b_code`, `date`, `category`, `book_type`, `publisher`, `price` FROM `addbook` WHERE name LIKE '%"+txtsearch.getText()+"%'";
